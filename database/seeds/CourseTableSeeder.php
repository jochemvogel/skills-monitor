...
class CourseTableSeeder extends Seeder
{
  public function run()
  {
    ...
    $course1->real_abbreviation = true;
    ...
    $course2->real_abbreviation = true;
    ...
    $course3->real_abbreviation = true;
    ...
    $course4->real_abbreviation = true;
    ...
    $course5->real_abbreviation = true;
